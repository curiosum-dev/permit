defmodule PhoenixAuthorization.AuthorizeHook do
  @moduledoc """
  ...
  For convenience, you might return this tuple from a function that you might import into the router.
    ...
    live_session :some_session, on_mount: PhoenixAuthorization.AuthorizeHook do
  ...
  defp just_authorize(socket) do
    ...
    if PhoenixAuthorization.Resolver.authorized_without_preloading?(
         subject,
  ...
  defp preload_and_authorize(socket, params) do
    ...
    case PhoenixAuthorization.Resolver.authorize_with_preloading!(
           subject,
           authorization_module,
           resource_module,
           action,
