defmodule PhoenixAuthorization.LiveViewTest.EndpointOverridable do
  defmacro __before_compile__(_env) do
    quote do
      ...
      def call(conn, _) do
        ...
        |> PhoenixAuthorization.LiveViewTest.LiveRouter.call([])
      end
    end
  end
end

defmodule PhoenixAuthorization.LiveViewTest.Endpoint do
  use Phoenix.Endpoint, otp_app: :phoenix_live_view

  @before_compile PhoenixAuthorization.LiveViewTest.EndpointOverridable
