...
defmodule Permit.Permissions.QueryConstructionTest do
  ...
  setup do
    ...
    %{resource: resource, convertible: query_convertible, convertible_nil: query_convertible_nil, nonconvertible: query_nonconvertible}
  end
  ...
  describe "Permit.Permissions.construct_query/3" do
    ...
    test "should construct proper query with or", %{resource: res, convertible: permissions} do
     ...
     test "should construct proper query with like operator", %{resource: res, convertible: permissions} do
    ...
    test "should construct proper query with eq and not nil", %{resource: res, convertible: permissions} do
  ...
  defp compare_query(
    ...
    %Ecto.Query{from: from, wheres: [%{expr: expr, op: op, params: params}]}), do: true
