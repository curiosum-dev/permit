defmodule Permit.LiveViewTest.EndpointOverridable do
  defmacro __before_compile__(_env) do
    quote do
      ...
      def call(conn, _) do
        ...
        |> Permit.LiveViewTest.LiveRouter.call([])
      end
    end
  end
end

defmodule Permit.LiveViewTest.Endpoint do
  use Phoenix.Endpoint, otp_app: :phoenix_live_view

  @before_compile Permit.LiveViewTest.EndpointOverridable
